...
Install:
Einfach im Home unzip TinyMacros-xxx-INSTALL.zip.
Damit wird ein Verzeichnis TinyMacros erstellt.
Die .tfrc daraus ins home kopieren.
Wenn das Verzeichnis irgendwoanders hin kopiert wird, bitte
